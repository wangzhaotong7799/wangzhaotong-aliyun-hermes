...
飞书文本消息有**隐性长度限制**，超过限制的报告会被截断或发送失败（API 400错误/消息后段丢失）。
...
**原则：文本消息发精简，Word附件发完整。** 不要将完整版报告作为文本消息发送。

| 版本 | 行数 | 用途 |
|:---|:---:|:---|
| 完整版 (data/report_YYYYMM.md) | 300-500 | → 转 Word 附件 |
| 精简版 (final response) | 50-80 | → 飞书文本消息 |

**精简版内容规范：**
1. 评分排行表（3-4列：排名、赛道、评分、一句话评级）
2. Top 3 赛道一句话点评
3. 一句话总体判断

**精简版禁止包含：** 详细赛道分析、完整策略方案、失败案例详细、数据来源附录——这些放 Word 附件。
